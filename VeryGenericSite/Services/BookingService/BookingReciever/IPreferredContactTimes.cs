...
{
    public interface IPreferredContactTimes
    {
        DateTime[] PrefferedContactTimeRange(Priority prio);
        DateTime PreferredTimeStart(Priority prio);
        DateTime PreferredTimeEnd(Priority prio);
    }
}
