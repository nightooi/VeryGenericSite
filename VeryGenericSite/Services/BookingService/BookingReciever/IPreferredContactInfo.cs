...
{
    public interface IPreferredContactInfo
    {
        PreferredContactType GetPreferredContactType(Priority prio);
        IPreferredContactTimes PreferredContactTimes(Priority prio);
    }
}
