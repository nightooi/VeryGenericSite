...
{
    public class IDefineTagHelper
    {
        public enum Tags {
            undefinded, end, a, abbr, address, area, article, aside, audio, b, Hbase, bdi, bdo, blockquote,
            ...
            main, picture, pre, progress, q, rp, rt, ruby, s, samp, script, search, section, select, small, source, span,
